...
class ControllerMetric:
    ...
    linear_jerks: np.ndarray = field(default_factory=lambda: np.empty((0, 1)))  # [m/s^3] jerk
    ms_linear_jerk: float = 0.0  # [m/s^3] mean squared linear jerk
    angular_jerks: np.ndarray = field(default_factory=lambda: np.empty((0, 1)))  # [rad/s^3] angular jerk
